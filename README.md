...
Kyanos is a Python-based desktop AI chatbot built using **PyQt6** for the user interface and an **AI API** for intelligent responses.  
...
![Frustration Handling](aurorai-ui.png)
